    ...
    public void postConstruct() {
        ...
        try {
            ...
            for (int i = 0; i < Integer.parseInt(propertyProvider.getProperty("POOL_SIZE")); i++) {
                pool.add(DriverManager.getConnection(propertyProvider.getProperty("JDBC_URL"), propertyProvider.getProperty("DB_USER"), propertyProvider.getProperty("DB_PASSWORD")));
            }
